...
This is a demonstration of a simple RNA-seq analysis pipeline. The objective is ***NOT*** to find significant results.
...
Please refer to this [bash script](RNA-seq_preproc.sh) for the code of data preprocessing.
